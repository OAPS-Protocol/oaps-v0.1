...
| Developers    | Read Technical Spec                 | [Specification Preview](#specification-preview)   |
| Everyone      | Get Started Guide                   | [GETTING_STARTED.md](GETTING_STARTED.md)          |
...
|----------------------------|---------------------|--------------------------------------------------------------------------------|
| Protocol Specification     | ✅ Complete         | [Specification Preview](#specification-preview)                                |
...
View the full technical specification in rendered format (recommended):

- **Best Experience**: Use the dApp's built-in preview button for beautiful Markdown rendering
- **Alternative**: [View Raw Specification](https://raw.githubusercontent.com/OAPS-Protocol/oaps-v0.1/main/SPECIFICATION.md) (plain text)
...
- Gather feedback & refine tooling
